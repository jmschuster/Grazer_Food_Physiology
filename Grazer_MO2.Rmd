...
CageExpSub <- CageExpSub %>% mutate(Signif = case_when(
  ...
  Species=='Mesocentrotus franciscanus' & Week=='Week 2' & Treatment=='Saccharina' ~ 'Yes',
  ...
  Species=='Pomaulax gibberosus' & Week=='Week 2' & Treatment=='Saccharina' ~ 'Yes',
...
#plot3a<-plot3a+ stat_pvalue_manual(stat.test, label = "p.adj.signif", tip.length = 0.003,hide.ns = TRUE) 
###
...
#plot3b<-plot3b+ stat_pvalue_manual(stat.test, label = "p.adj.signif", tip.length = 0.003,hide.ns = TRUE,y.position='y.position.new') 
...
#plot3c<-plot3c + stat_pvalue_manual(stat.test, label = "p.adj.signif", tip.length = 0.003,hide.ns = TRUE) 
###
...
#plot3d<-plot3d + stat_pvalue_manual(stat.test, label = "p.adj.signif", tip.length = 0.003, hide.ns = TRUE) 
