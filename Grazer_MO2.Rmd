...
Mfra<-Mfra %>% filter(res2.VO2.WW<4) # remove 2 outliers (row 16 and 37 of full Mfra df)
# Week 7
grubbs.test(Mfra7$res2.VO2.WW) # outlier test
grubbs.test(Mfra7$res2.VO2.WW, opposite=TRUE) # outlier test (lowest)
Mfra7<-Mfra7 %>% filter(res2.VO2.WW<1 & res2.VO2.WW >-0.8) # remove 2 outliers 
...
Pgib<-Pgib %>% filter(res2.VO2.WW<1.1 & res2.VO2.WW >-0.9) # remove 5 outliers
...
Tpul$res2.VO2.WW.Ind<-(Tpul$res2.VO2.WW/Tpul$N_Dusky)
...
# Non-parametric test of treatment differences
kruskal.test(res2.VO2.WW.Ind ~ Treatment, data = Tpul) # KW test for multiple treatment levels

# Test which treatment levels are different:
wilcox_test(res2.VO2.WW.Ind ~ Treatment, data = Tpul, p.adjust.method = "bonferroni")
